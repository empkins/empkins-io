...
from empkins_io.datasets.d03._utils.check_data_completeness import check_data_completeness
...
class MicroBaseDataset(Dataset):
    ...
    def subset_micro1_0(self):
        ...
        self.subset_index = self.index.query("subject >= 'VP_01' and subject <= 'VP_45'")
        return self
