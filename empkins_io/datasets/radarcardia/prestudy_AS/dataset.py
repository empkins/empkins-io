...
"""
Dataset for Radar and BIOPAC data recorded in Erlangen at 2023-09-13
Pre Study data for whole body
"""


class RadarCardiaPreStudyASDataset(BaseDataset):
    ...
    def create_index(self):
        ...
        # front
        body_parts_1 = ["aorta"]
        body_parts_2 = ["carotis", "elbow", "wrist", "knee_back"]
