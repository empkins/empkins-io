...
"""
Dataset for Radar and BIOPAC data recorded in Erlangen at 2023-09-14
Pre Study data for carotis with nilspod
"""


class RadarCardiaPreStudyNPDataset(BaseDataset):
    ...
    def create_index(self):
        ...
        body_parts = ["sync", "carotis"]
        breathing = ["normal"]

        index = list(product(body_parts, breathing))
